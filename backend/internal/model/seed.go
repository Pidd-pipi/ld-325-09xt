...
func Seed(db *gorm.DB) error {
	...
	offers := []Offer{{ProductID: products[0].ID, SupplierID: suppliers[0].ID, UnitPrice: 398, MOQ: 10, Freight: "满 30 片送货上门", DeliveryDays: 3, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[0].ID, SupplierID: suppliers[1].ID, UnitPrice: 412, MOQ: 5, Freight: "同城配送 80 元", DeliveryDays: 2, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[1].ID, SupplierID: suppliers[1].ID, UnitPrice: 188, MOQ: 20, Freight: "满 100 ㎡免运费", DeliveryDays: 5, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[1].ID, SupplierID: suppliers[0].ID, UnitPrice: 205, MOQ: 10, Freight: "物流到楼下", DeliveryDays: 4, StockStatus: constants.StatusOutOfStock, Version: constants.OfferInitialVersion}, {ProductID: products[2].ID, SupplierID: suppliers[0].ID, UnitPrice: 538, MOQ: 2, Freight: "满 6 桶免运费", DeliveryDays: 2, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[3].ID, SupplierID: suppliers[2].ID, UnitPrice: 1299, MOQ: 1, Freight: "包邮入户", DeliveryDays: 7, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[4].ID, SupplierID: suppliers[0].ID, UnitPrice: 79, MOQ: 5, Freight: "满 500 元包邮", DeliveryDays: 2, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}, {ProductID: products[5].ID, SupplierID: suppliers[1].ID, UnitPrice: 680, MOQ: 8, Freight: "测量后报价", DeliveryDays: 12, StockStatus: constants.StatusInStock, Version: constants.OfferInitialVersion}}
